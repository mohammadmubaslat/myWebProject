...
if(isset($_POST['logIn'])){
    ...
    if(isset($_POST['username']) && isset($_POST['password'])) {
        ...
        $sql = " SELECT * FROM `user_info` , `email_info` WHERE email_id = user_id and email='$email'";
                ...
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <form action="Login.php" method="post">
                        <div class="row px-3"> <label class="mb-1">
                            ...
                            <input class="mb-4" type="text" name="username" placeholder="Enter a valid email address"> </div>
                        <div class="row px-3"> <label class="mb-1">
                        ...
                        <div class="row mb-3 px-3"> <button type="submit" name="logIn" id="logIn" class="btn btn-blue text-center">Login</button> </div>
                        <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account? <a  href="SignUP.php" class="text-danger ">Register</a></small> </div>
                    </form>
                </div>
            </div>
        </div>
